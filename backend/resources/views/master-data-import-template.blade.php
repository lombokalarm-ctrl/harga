...
<head>
    ...
    <style>
        ...
        p { margin: 0 0 8px; }
        .note { padding: 12px; background: #f8fafc; border: 1px solid #cbd5e1; border-radius: 8px; }
...
<body>
    <h1>{{ $title }}</h1>
    <p>Gunakan template CSV atau XLSX resmi untuk proses upload master data musiman. PDF ini menjadi panduan baku agar struktur file dan pengisian data tetap konsisten.</p>
    ...
    <div class="note">
        ...
        <p>4. Gunakan nilai status <strong>active</strong> atau <strong>inactive</strong>.</p>
    </div>
